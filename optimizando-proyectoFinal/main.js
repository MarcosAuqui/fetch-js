...
const producto1 = new producto(1,"Serenisima","Leche", 150, "leche.jpg")

const producto2 = new producto(2,"Gallo de Oro","Arroz", 120, "arroz.jpg")

const producto3 = new producto(3,"Quilmes", "Cerveza", 240, "cerveza.jpg")

const producto4 = new producto(4,"Merengadas","Galletitas", 100, "galletas.jpg")

const producto5 = new producto(5,"doritos", "Doritos", 170, "doritos.jpg")

const producto6 = new producto(6,"lays", "Papas fritas", 190, "papas-lays.jpg")

const producto7 = new producto(7,"Dánica","Manteca", 300, "manteca.jpg")

const producto8 = new producto(8,"Ledesma", "Manteca", 200, "azucar.jpg")

const producto9 = new producto(9,"magistral", "Magistral", 340, "magistral.jpg")
...
function crearProducto(array){
    ...
    let nuevoProd = new producto(array.length+1, inputMarca.value, inputTipo.value, inputPrecio.value, "leche.jpg")
...
setTimeout(()=>{
    console.log(`qeste es un mensaaje intrusivo`)
}, 4500)

setTimeout( () => {
    console.log(`son todos rre trolos aca`)
}, 6000 )
...
// para que cada letraa aprezca cada 1 segundo

/* let time = 0

for (let cadaLetra of "que onda negraso"){
    time += 1000
    setTimeout(() =>{
...
console.log("final de process")
 */
// set interval, dos paramnetros, function y tiempos
let i = 0
const intervalo = setInterval(() => {
    ...
    if(i >= 5){
        ...
        console.log("se acabo el tiquitaca")
    }
}, 1000);
...
const eventroFuturo = (valor) => {
    return new Promise((resolve, reject) => {
        // cuerpo de la promesa - intruscciones cuando se resuelve y cuando se rechaza
        setTimeout(() =>{
            if(valor){
                resolve()
            }else{
...
console.log(eventroFuturo (true))
console.log(eventroFuturo (false))
...
const tutor1 = new Tutor ("Carla", "Pontani")
const tutor2 = new Tutor("andres","pata")
const tutor3 = new Tutor("yeison", "rodriguez")
let tutores = [tutor1, tutor2, tutor3]

function consunltarPromesa(resultado){
    return new  Promise((res, rej)=>{
        if(resultado){
            res(tutores)
        }else{
            rej("no se pudo cargar los tutores")
        }
    })
}
consunltarPromesa(true)
